...
Gli ENV (TIMMY_LOG_MAX_BYTES, TIMMY_LOG_PROPAGATE, TIMMY_OTEL_ENDPOINT, ?) restano invece
dedicati ai dettagli infrastrutturali come rotazione file, propagate ed endpoint OTEL.
"""
