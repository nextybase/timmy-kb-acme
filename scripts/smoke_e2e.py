...
def main() -> int:
    ...
    print("[4/4] Eseguo orchestratore onboarding_full_main…")
    ...
    # Log opzionali: non rendere blocking l’assenza del file specifico
    ...
    if log_candidates:
        print(f"      OK: log creato → {log_candidates[0]}")
    else:
