...
# 🚀 OnBoarding NeXT – v1.3.1

Benvenuto nel repository ufficiale del sistema di onboarding per il progetto **NeXT**.  
Questa versione (`v1.3.1`) porta robustezza, explainability e logging uniforme a livello enterprise, con una gestione degli errori interamente “exception-first”, policy di logging aggiornata e nuovi strumenti CLI di refactoring.
...
- 🛡️ **Exception-first**: ogni errore critico solleva un’eccezione custom, mai più errori silenziosi
...
- ✔️ Conversione batch PDF→Markdown arricchito e tagging semantico
...
Dettagli, naming convention e policy: `coding_rule.md`
