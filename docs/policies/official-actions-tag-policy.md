...
- **Regola fondamentale**: mai pinare a SHA commit speficici per le action ufficiali. Un tag stabile (`v4`, `v5`, `v4.4.3`, ...) garantisce compatibilità e usabilità dei workflow da GitHub.  
