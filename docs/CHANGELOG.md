...
- Il payload Vision ora aggiunge `assistant_id` e `assistant_id_source` (log `vision_alignment_check.assistant_id`), migliorando la tracciabilità dei fallimenti dell’assistente.
