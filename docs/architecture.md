...
4. **Preview (Docker)**:
   - Se Docker è presente: **build + serve HonKit in modalità _detached_** (non blocca).  
...
- **No `print()`** nei moduli e negli orchestratori (solo prompt dove previsto e output informativi via logger).
