...
- **Installazione**
  - [Guida installazione](user/installation_guide.md)
...
- **[Guida installazione](user/installation_guide.md)** - setup passo-passo (software, venv, dipendenze, test architettura, avvio UI).
