...
def test_build_chunk_records_raises_on_expected_frontmatter_error(monkeypatch: MonkeyPatch, tmp_path: Path) -> None:
...
def test_build_chunk_records_raises_on_frontmatter_pipeline_error(monkeypatch: MonkeyPatch, tmp_path: Path) -> None:
    md_path = tmp_path / "doc.md"
    md_path.write_text("# Titolo\n\ncontenuto", encoding="utf-8")
