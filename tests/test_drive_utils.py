...
def test_drive_service_connection():
    ...
    try:
        ...
        print("✅ Connessione a Google Drive API riuscita.")
...
def test_download_pdfs():
    ...
    try:
        ...
        print("✅ Download PDF da Drive riuscito.")
    except Exception as e:
...
def test_create_structure_from_yaml():
    ...
    try:
        ...
        print("✅ Struttura cartelle creata correttamente da YAML.")
    except Exception as e:
...
def test_find_folder():
    ...
    try:
        ...
        print(f"✅ Cartella trovata: {folder['name']} (ID: {folder['id']})")
    except Exception as e:
...
def test_upload_config():
    ...
    print(f"🔍 DEBUG: drive_folder_id = {config.drive_folder_id}")
    ...
    try:
        ...
        print(f"✅ Config.yaml caricato con ID: {config_id}")
    except Exception as e:
