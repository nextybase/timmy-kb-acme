...
def test_cli_returns_pipelineerror_exit_code(tmp_path: Path, monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr(convert_service, "convert_markdown", lambda *_a, **_k: None, raising=True)
    ...
    monkeypatch.setattr(frontmatter_service, "enrich_frontmatter", lambda *_a, **_k: ["A.md"], raising=True)
    ...
    monkeypatch.setattr(frontmatter_service, "write_summary_and_readme", _raise_pipe, raising=True)
...
def test_cli_summary_log_excludes_readme_summary(tmp_path: Path, monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr(convert_service, "convert_markdown", _fake_convert, raising=True)
    ...
    monkeypatch.setattr(sapi, "_require_reviewed_vocab", lambda _b, _l, **_k: {}, raising=True)
    monkeypatch.setattr(frontmatter_service, "enrich_frontmatter", lambda *_a, **_k: ["cat.md"], raising=True)
    monkeypatch.setattr(frontmatter_service, "write_summary_and_readme", lambda *_a, **_k: None, raising=True)
