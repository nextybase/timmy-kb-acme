...
- All Codex work flows through the numbered Prompt Chain (Phase 0 analytical/read-only, Phase 1..N operational micro-PRs, Prompt N+1 final QA) defined in `docs/PromptChain_spec.md` and `.codex/PROMPTS.md`; never skip or merge phases.
